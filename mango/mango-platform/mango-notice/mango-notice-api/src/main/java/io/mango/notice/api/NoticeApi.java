...
public interface NoticeApi {
    ...
    R<PageResult<NoticeInboundMessageVO>> listInboundMessages(@Valid NoticeInboundMessagePageQuery query);

    R<NoticeInboundMessageVO> getInboundMessage(@Positive Long id);
