...
public class WorkflowTemplateController implements WorkflowTemplateApi {
    ...
    public R<WorkflowTemplateVO> get(
        ...
        return R.ok(workflowTemplateService.get(id));
    }
    ...
    public R<Boolean> delete(
            @Parameter(description = "流程模板ID", required = true)
            @RequestParam("id") Long id) {
        return R.ok(workflowTemplateService.delete(id));
    }
