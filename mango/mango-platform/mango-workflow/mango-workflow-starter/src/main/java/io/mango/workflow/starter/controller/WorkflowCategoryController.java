...
public class WorkflowCategoryController implements WorkflowCategoryApi {
    ...
    public R<List<WorkflowCategoryVO>> list(
        ...
        return R.ok(workflowCategoryService.list(status, domainCode));
    }
    ...
    public R<WorkflowCategoryVO> get(
        ...
        return R.ok(workflowCategoryService.get(id));
    }
    ...
    public R<Boolean> delete(
            @Parameter(description = "流程分类ID", required = true)
            @RequestParam("id") Long id) {
        return R.ok(workflowCategoryService.delete(id));
    }
}
