...
public class WorkflowTemplateCategoryController implements WorkflowTemplateCategoryApi {
    ...
    public R<List<WorkflowTemplateCategoryVO>> list(
        ...
        return R.ok(workflowTemplateCategoryService.list(status));
    }
    ...
    public R<WorkflowTemplateCategoryVO> get(
        ...
        return R.ok(workflowTemplateCategoryService.get(id));
    }
    ...
    public R<Boolean> delete(
            @Parameter(description = "流程模板分类ID", required = true)
            @RequestParam("id") Long id) {
        return R.ok(workflowTemplateCategoryService.delete(id));
    }
}
