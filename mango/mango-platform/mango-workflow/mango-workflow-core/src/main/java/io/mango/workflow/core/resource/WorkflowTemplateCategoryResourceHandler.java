...
public class WorkflowTemplateCategoryResourceHandler implements ResourceHandler {

    private static final String TARGET_TABLE = "workflow_template_category";
    private static final Long DEFAULT_TENANT_ID = 1L;
    private static final int ENABLED = 1;
    private static final int DISABLED = 0;

    private final WorkflowTemplateCategoryMapper categoryMapper;

    @Override
    public String resourceType() {
        return ResourceTypes.WORKFLOW_TEMPLATE_CATEGORY;
    }
    ...
    public ResourceHandlerSpec spec() {
        return ResourceHandlerSpec.builder()
                ...
                .fieldDescription("categoryId", "流程模板分类稳定 ID，可选；不填时使用资源 ID。")
                .fieldDescription("tenantId", "租户 ID，默认 1。")
                .fieldDescription("parentId", "父分类 ID。")
                .fieldDescription("categoryCode", "流程模板分类编码，租户内唯一。")
                .fieldDescription("categoryName", "流程模板分类名称。")
                .fieldDescription("icon", "分类图标。")
    ...
    public ResourceSyncResult upsert(ResourceDeclaration resource) {
        ...
        return ResourceSyncResult.of(entity.getId(), TARGET_TABLE,
                "Workflow template category synced: " + entity.getCategoryCode());
    }
    ...
    public ResourceSyncResult disable(ResourceDeclaration resource) {
        ...
        categoryMapper.updateById(entity);
        return ResourceSyncResult.of(entity.getId(), TARGET_TABLE,
                "Workflow template category disabled: " + entity.getCategoryCode());
    }
    ...
    private record Payload(Long categoryId, Long tenantId, Long parentId, String categoryCode,
                           String categoryName, String icon, Integer sort, Integer status, String remark) {
        ...
        private static Payload from(ResourceDeclaration resource) {
            return new Payload(
                    ...
                    WorkflowResourceFields.longValue(resource, "parentId", false, null),
                    WorkflowResourceFields.requiredText(resource, "categoryCode",
                            ResourceTypes.WORKFLOW_TEMPLATE_CATEGORY),
