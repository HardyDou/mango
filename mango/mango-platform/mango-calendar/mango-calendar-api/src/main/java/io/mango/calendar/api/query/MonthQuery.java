...
@Data
@Schema(description = "月份工作日查询")
public class MonthQuery implements Serializable {
    ...
    @Min(value = 1, message = "月份取值为 1-12")
    @Max(value = 12, message = "月份取值为 1-12")
    @Schema(description = "月份，1-12", requiredMode = Schema.RequiredMode.REQUIRED)
