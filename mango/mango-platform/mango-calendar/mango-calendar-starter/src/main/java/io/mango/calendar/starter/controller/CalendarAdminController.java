...
public class CalendarAdminController implements CalendarAdminApi {
    ...
    public R<PageResult<CalendarVO>> pageCalendars(@ParameterObject CalendarPageQuery query) {
    ...
    public R<List<CalendarOptionVO>> listCalendarOptions(@ParameterObject CalendarOptionQuery query) {
    ...
    public R<Long> createCalendar(@RequestBody CreateCalendarCommand command) {
    ...
    public R<Boolean> updateCalendar(@RequestBody UpdateCalendarCommand command) {
    ...
    public R<Boolean> updateCalendarStatus(@RequestBody UpdateCalendarStatusCommand command) {
    ...
    public R<PageResult<CalendarYearSummaryVO>> pageCalendarYears(@ParameterObject CalendarYearPageQuery query) {
    ...
    public R<Boolean> initCalendarYear(@RequestBody InitCalendarYearCommand command) {
    ...
    public R<Boolean> refreshCalendarYearLunar(@RequestBody RefreshCalendarYearLunarCommand command) {
    ...
    public R<Boolean> updateCalendarYearEnabled(@RequestBody UpdateCalendarYearEnabledCommand command) {
    ...
    public R<Boolean> deleteCalendarYear(
            ...
            @RequestParam(name = "calendarCode") String calendarCode,
    ...
    public R<CalendarYearSummaryVO> yearSummary(@ParameterObject CalendarYearSummaryQuery query) {
    ...
    public R<PageResult<CalendarDayVO>> pageCalendarDays(@ParameterObject CalendarDayPageQuery query) {
    ...
    public R<Boolean> updateCalendarDay(@RequestBody UpdateCalendarDayCommand command) {
    ...
    public R<Boolean> batchUpdateCalendarDays(@RequestBody BatchUpdateCalendarDaysCommand command) {
    ...
    public R<Boolean> importCalendarDays(@RequestBody ImportCalendarDaysCommand command) {
