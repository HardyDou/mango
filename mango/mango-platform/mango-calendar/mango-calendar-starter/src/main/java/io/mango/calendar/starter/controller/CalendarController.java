...
public class CalendarController implements CalendarApi {
    ...
    public R<CalendarDayVO> getDay(@ParameterObject CalendarDateQuery query) {
    ...
    public R<Boolean> isWorkday(@ParameterObject CalendarDateQuery query) {
    ...
    public R<LocalDate> nextWorkday(@ParameterObject CalendarDateQuery query) {
    ...
    public R<LocalDate> previousWorkday(@ParameterObject CalendarDateQuery query) {
    ...
    public R<LocalDate> addWorkdays(@ParameterObject AddWorkdaysQuery query) {
    ...
    public R<Integer> countWorkdays(@ParameterObject CountWorkdaysQuery query) {
    ...
    public R<List<CalendarDayVO>> listDays(@ParameterObject DateRangeQuery query) {
    ...
    public R<List<CalendarDayVO>> batchCheck(@RequestBody BatchCheckWorkdayRequest query) {
    ...
    public R<MonthWorkdaySummaryVO> monthSummary(@ParameterObject MonthQuery query) {
    ...
    public R<LocalDate> firstWorkdayOfMonth(@ParameterObject MonthQuery query) {
    ...
    public R<LocalDate> lastWorkdayOfMonth(@ParameterObject MonthQuery query) {
    ...
    public R<LocalDate> nthWorkdayOfMonth(@ParameterObject NthWorkdayOfMonthQuery query) {
    ...
    public R<LunarDayInfoVO> lunarDay(@ParameterObject SolarDateQuery query) {
    ...
    public R<LocalDate> lunarToSolar(@ParameterObject LunarDateQuery query) {
    ...
    public R<List<SolarTermVO>> solarTerms(@ParameterObject SolarTermYearQuery query) {
