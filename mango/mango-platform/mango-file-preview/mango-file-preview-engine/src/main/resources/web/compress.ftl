...
<head>
    ...
    <script src="${kkResourceBaseUrl}js/jquery-3.6.1.min.js"></script>
    <#include "*/commonHeader.ftl">
    <script src="${kkResourceBaseUrl}js/base64.min.js" type="text/javascript"></script>
    <link href="${kkResourceBaseUrl}css/zTreeStyle.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="${kkResourceBaseUrl}js/jquery.ztree.core.js"></script>
    <style type="text/css">
        :root {
            --page-bg: #eef1f4;
            --page-accent: #d9dee5;
