...
<head>
    ...
    <link rel='stylesheet' href='${kkResourceBaseUrl}xlsx/plugins/css/pluginsCss.css' />
    <link rel='stylesheet' href='${kkResourceBaseUrl}xlsx/plugins/plugins.css' />
    <link rel='stylesheet' href='${kkResourceBaseUrl}xlsx/css/luckysheet.css' />
    <link rel='stylesheet' href='${kkResourceBaseUrl}xlsx/assets/iconfont/iconfont.css' />
    <script src="${kkResourceBaseUrl}xlsx/plugins/js/plugin.js"></script>
    <script src="${kkResourceBaseUrl}xlsx/luckysheet.umd.js"></script>
    <script src="${kkResourceBaseUrl}js/watermark.js" type="text/javascript"></script>
    <script src="${kkResourceBaseUrl}js/base64.min.js" type="text/javascript"></script>
</head>
