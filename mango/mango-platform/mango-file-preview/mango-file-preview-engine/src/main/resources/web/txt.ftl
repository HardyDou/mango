...
<head>
    ...
    <script src="${kkResourceBaseUrl}js/jquery-3.6.1.min.js" type="text/javascript"></script>
    <link rel="stylesheet" href="${kkResourceBaseUrl}bootstrap/css/bootstrap.min.css"/>
    <script src="${kkResourceBaseUrl}bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="${kkResourceBaseUrl}js/base64.min.js" type="text/javascript"></script>
</head>
<body>
<input hidden id="textData" value="${textData}"/>
<link rel="stylesheet" href="${kkResourceBaseUrl}highlight/highlight.css">
<!-- 先加载fenye.js -->
<script src="${kkResourceBaseUrl}js/fenye.js" type="text/javascript"></script>
