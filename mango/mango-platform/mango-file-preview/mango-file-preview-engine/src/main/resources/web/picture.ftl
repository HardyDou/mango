...
<head>
    ...
    <link rel="stylesheet" href="${kkResourceBaseUrl}css/viewer.min.css">
    <script src="${kkResourceBaseUrl}js/viewer.min.js"></script>
    <script src="${kkResourceBaseUrl}js/base64.min.js"></script>
    <style>
        body {
