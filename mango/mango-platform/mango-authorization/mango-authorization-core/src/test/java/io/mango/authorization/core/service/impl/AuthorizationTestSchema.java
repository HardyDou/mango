...
/**
 * Keeps integration-test schemas aligned with the canonical Mango tenant entity fields.
 */
final class AuthorizationTestSchema {

    private AuthorizationTestSchema() {
    }
