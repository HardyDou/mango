...
(260402,1,'internal-admin','mango-workflow',2604,2,'流程定义','system:workflow','/workflow/manage/definition','Files','@/views/system/workflow-definition/index.vue',2,1,1,0,0,NULL,'system:workflow:list',NULL,NULL,NOW(),NOW(),'流程分类与流程定义管理',0,NULL,NOW(),NULL,NOW()),
