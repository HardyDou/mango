...
INSERT INTO `authorization_menu` (`menu_id`, `app_code`, `parent_id`, `menu_type`, `menu_name`, `menu_code`, `path`, `component`, `icon`, `sort`, `status`, `visible`, `keep_alive`, `embedded`) VALUES
(1, 'internal-admin', 0, 1, '系统管理', 'system', '/system', NULL, 'Setting', 1, 1, 1, 0, 0),
(2, 'internal-admin', 1, 2, '用户管理', 'system:user', '/system/user', '@/views/system/user/index.vue', 'User', 1, 1, 1, 0, 0),
(3, 'internal-admin', 1, 2, '角色管理', 'system:role', '/system/role', '@/views/system/role/index.vue', 'Role', 2, 1, 1, 0, 0),
(4, 'internal-admin', 1, 2, '菜单管理', 'system:menu', '/system/menu', '@/views/system/menu/index.vue', 'Menu', 3, 1, 1, 0, 0);
