 ...
 */
@Slf4j
public class JjwtTokenProvider implements ITokenProvider {
    ...
    public JjwtTokenProvider(@Autowired(required = false) IKvStore kvStore) {
    ...
    public TokenPairVO refresh(String refreshToken) {
        ...
        return new TokenPairVO(newAccessToken, newRefreshToken);
    }
