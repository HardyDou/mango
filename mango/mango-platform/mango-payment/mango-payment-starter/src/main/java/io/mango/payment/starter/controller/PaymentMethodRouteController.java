...
public class PaymentMethodRouteController implements PaymentMethodRouteApi {
    ...
    public R<PageResult<PaymentMethodRouteRuleVO>> pageRouteRules(@ParameterObject PaymentMethodRoutePageQuery query) {
        return R.ok(routeService.pageRouteRules(query));
    }
    ...
    public R<PaymentMethodRouteRuleVO> detailRouteRule(@Parameter(description = "路由规则 ID", required = true) @RequestParam("id") Long id) {
        return R.ok(routeService.detailRouteRule(id));
    }
    ...
    public R<Boolean> deleteRouteRule(@Parameter(description = "路由规则 ID", required = true) @RequestParam("id") Long id) {
        return R.ok(routeService.deleteRouteRule(id));
    }
