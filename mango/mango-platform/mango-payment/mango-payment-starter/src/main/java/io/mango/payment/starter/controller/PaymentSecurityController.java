...
public class PaymentSecurityController implements PaymentSecurityApi {
    ...
    private final IPaymentSensitiveFieldReencryptService sensitiveFieldReencryptService;
    ...
    public R<PaymentSensitiveFieldReencryptResultVO> reencryptSensitiveFields(
            @Parameter(description = "本轮最多处理记录数，1-1000") @RequestParam(value = "limit", defaultValue = "100") Integer limit) {
