...
VALUES
  (330005, 'FUIOU_PAY', '富友支付', 'PROD', 'AGGREGATOR', 'FUIOU_PAY', '0002900F0370542', 'https://fundwx.payfuiouo2o.com', NULL, NULL, 'https://fundwx.payfuiouo2o.com',
   ...
   '富友支付通道：当前已接入扫码 XML/RSA 主扫统一下单，支持微信扫码、支付宝扫码、查单、退款；商户号、机构号、RSA 密钥和通知地址在签约通道动态维护。富友报文终端号由系统按线上收款接口规则处理，不作为商户签约维护项；被扫、支付宝账号支付、网银等能力需完成对应适配器后再开放。',
   'HTTP', 1, 1, NULL, NOW(), NULL, NOW(), 0)
...
VALUES
  ...
  (332017, 330005, 'PERSONAL_WECHAT_QR', 'WEB', 'PROD', 1, 1, 0, 1, 1, 1, 1000000, 1, 1, NULL, NOW(), NULL, NOW(), 0)
ON DUPLICATE KEY UPDATE
