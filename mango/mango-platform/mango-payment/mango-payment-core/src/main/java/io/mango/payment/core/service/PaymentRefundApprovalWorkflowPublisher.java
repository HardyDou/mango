...
@Service
public class PaymentRefundApprovalWorkflowPublisher {
    ...
    public PaymentRefundApprovalWorkflowPublisher(
    ...
    public PaymentRemoteOutcome<WorkflowDeployVO> ensureRefundApprovalDefinition() {
        return PaymentRemoteResultSupport.outcome(workflowDefinitionApi.ensurePublished(definitionCommand()));
    }
    ...
    private String json(Object value) {
        try {
            ...
            return Require.fail(PaymentCode.PAYMENT_REFUND_APPROVAL_INVALID, "支付内置工作流JSON生成失败", e);
        }
    }
}
