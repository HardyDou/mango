...
public class PaymentSensitiveValueCodec {
    ...
    public String decrypt(String storedValue) {
        ...
        try {
            ...
            return Require.fail(PaymentCode.PAYMENT_SENSITIVE_VALUE_INVALID, PaymentCode.PAYMENT_SENSITIVE_VALUE_INVALID.getMessage(), ex);
        }
    }
