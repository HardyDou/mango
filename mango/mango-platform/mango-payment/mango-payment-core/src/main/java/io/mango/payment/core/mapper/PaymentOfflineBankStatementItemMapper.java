...
import io.mango.payment.core.model.projection.PaymentOfflineBankStatementItemProjection;
...
public interface PaymentOfflineBankStatementItemMapper extends BaseMapper<PaymentOfflineBankStatementItemEntity> {
    ...
    List<PaymentOfflineBankStatementItemProjection> selectItemsByBatch(
