...
@Service
public class PaymentFuiouGatewaySigner {
    ...
    public String signPlain(String plain, String merchantKey) {
        Require.notNull(plain, PaymentCode.PAYMENT_CHANNEL_INVALID, "富友网关 plain 报文不能为空");
        Require.notBlank(merchantKey, PaymentCode.PAYMENT_CHANNEL_CONTRACT_INVALID, "富友网关商户密钥不能为空");
    ...
    private String digest(Map<String, String> fields, List<String> orderedFields, String merchantKey) {
        Require.notNull(fields, PaymentCode.PAYMENT_CHANNEL_INVALID, "富友网关签名字段不能为空");
        Require.notBlank(merchantKey, PaymentCode.PAYMENT_CHANNEL_CONTRACT_INVALID, "富友网关商户密钥不能为空");
    ...
    private byte[] md5(String value) {
        try {
            ...
            return Require.fail(PaymentCode.PAYMENT_CHANNEL_INVALID, "富友网关签名失败");
        }
    }
