...
@Service
public class PaymentFuiouSigner {
    ...
    public String canonicalText(Map<String, String> fields) {
        Require.notNull(fields, PaymentCode.PAYMENT_CHANNEL_INVALID, "富友签名字段不能为空");
    ...
    public String sign(Map<String, String> fields, String privateKey) {
        Require.notBlank(privateKey, PaymentCode.PAYMENT_CHANNEL_CONTRACT_INVALID, "富友商户私钥不能为空");
        try {
            ...
            return Require.fail(PaymentCode.PAYMENT_CHANNEL_INVALID, "富友报文签名失败", ex);
        }
    }
    ...
    public boolean verify(Map<String, String> fields, String publicKey) {
        ...
        try {
            ...
            return Require.fail(PaymentCode.PAYMENT_CHANNEL_INVALID, "富友报文验签失败", ex);
        }
    }
