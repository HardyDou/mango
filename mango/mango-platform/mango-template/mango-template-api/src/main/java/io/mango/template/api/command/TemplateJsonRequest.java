...
@Data
@NoArgsConstructor
public class TemplateJsonRequest {
    ...
    public TemplateJsonRequest(JsonNode value) {
        JsonNode resolved = value == null || value.isNull()
    ...
    public static TemplateJsonRequest of(Map<String, ?> value) {
        return new TemplateJsonRequest(OBJECT_MAPPER.valueToTree(value == null ? Map.of() : value));
    }
