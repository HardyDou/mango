...
public class TemplateController implements TemplateApi {
    ...
    public R<PageResult<TemplateVO>> page(@ParameterObject TemplatePageQuery query) {
        return R.ok(templateService.pageResult(query));
    }
    ...
    @Override
    public R<TemplateDetailVO> detail(@Parameter(description = "模板ID", required = true) @RequestParam("id") Long id) {
    ...
    @Override
    public R<Long> create(@RequestBody CreateTemplateCommand command) {
        return R.ok(templateService.create(command));
    }
    ...
    @Override
    public R<Boolean> update(@RequestBody UpdateTemplateCommand command) {
        return R.ok(templateService.update(command));
    }
    ...
    @Override
    public R<Boolean> delete(@Parameter(description = "模板ID", required = true) @RequestParam("id") Long id) {
    ...
    public R<Boolean> updateStatus(@RequestBody UpdateTemplateStatusCommand command) {
        return R.ok(templateService.updateStatus(command));
    }
    ...
    public R<Long> publishVersion(@RequestBody PublishTemplateVersionCommand command) {
        return R.ok(templateService.publishVersion(command));
    }
    ...
    public R<Boolean> activateVersion(@RequestBody ActivateTemplateVersionCommand command) {
        return R.ok(templateService.activateVersion(command));
    }
    ...
    public R<List<String>> extractVariables(@RequestBody ExtractTemplateVariablesCommand command) {
        return R.ok(templateService.extractVariables(command));
    }
    ...
    public R<TemplateRenderResultVO> render(@RequestBody TemplateRenderCommand command) {
        return R.ok(templateService.render(command));
    }
    ...
    public R<TemplateRenderResultVO> renderAsync(@RequestBody TemplateRenderCommand command) {
        return R.ok(templateService.renderAsync(command));
    }
    ...
    @Override
    public R<TemplateRenderRecordVO> renderRecord(@Parameter(description = "渲染记录ID", required = true) @RequestParam("id") Long id) {
        return R.ok(templateService.renderRecord(id));
    }
    ...
    public R<PageResult<TemplateRenderRecordVO>> renderRecordPage(@ParameterObject TemplateRenderRecordPageQuery query) {
        return R.ok(templateService.renderRecordPage(query));
    }
}
