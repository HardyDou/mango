...
public class SysMenuController implements SysMenuApi {
    ...
    public R<SysMenu> getById(
        ...
        io.mango.rbac.core.entity.SysMenu menu = sysMenuService.getById(menuId);
        if (menu == null) {
    ...
    public R<Void> add(@RequestBody io.mango.rbac.api.po.SysMenu menuPo) {
        io.mango.rbac.core.entity.SysMenu menu = convertToEntity(menuPo);
    ...
    public R<Void> update(
            @Parameter(description = "菜单ID") @PathVariable Long menuId,
            @RequestBody io.mango.rbac.api.po.SysMenu menuPo) {
        io.mango.rbac.core.entity.SysMenu menu = convertToEntity(menuPo);
     ...
     */
    private SysMenu convertToApiPo(io.mango.rbac.core.entity.SysMenu entity) {
        if (entity == null) {
            return null;
        }
     ...
     */
    private io.mango.rbac.core.entity.SysMenu convertToEntity(io.mango.rbac.api.po.SysMenu po) {
        if (po == null) {
            return null;
        }
        io.mango.rbac.core.entity.SysMenu entity = new io.mango.rbac.core.entity.SysMenu();
