...
/** Stable positive primary keys for rows created from portable Resources. */
public final class PortableResourceIds {

    private PortableResourceIds() {
    }
    ...
    public static long declaredOrStable(Long declaredId, String targetTable, Object... identityParts) {
        ...
        if (declaredId <= 0L) {
            throw new IllegalArgumentException("Portable Resource targetId must be positive");
        }
        return declaredId;
    }
