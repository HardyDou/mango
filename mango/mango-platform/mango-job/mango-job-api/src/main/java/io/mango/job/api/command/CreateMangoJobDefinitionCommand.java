...
@Schema(description = "创建 Job 任务定义命令")
public class CreateMangoJobDefinitionCommand implements Serializable {
    ...
    @Size(max = 65535, message = "参数表单 schema JSON 不能超过65535个字符")
    @Schema(description = "参数表单 schema JSON")
    private String paramSchema;

    @Size(max = 65535, message = "默认参数 JSON 不能超过65535个字符")
    ...
    @Size(max = 65535, message = "重试策略 JSON 不能超过65535个字符")
