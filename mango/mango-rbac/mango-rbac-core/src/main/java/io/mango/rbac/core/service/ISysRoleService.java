 ...
 * Defined in rbac-core, not exposed across modules.
 *
 * <p>Role management capabilities include CRUD operations on roles,
 * assignment of roles to users, and assignment of menus to roles.
...
public interface ISysRoleService {
    ...
    /**
     * Delete a role and all its user-role and role-menu relationships.
     *
     ...
     * @return list of roles assigned to the user, empty list if none
     */
