...
import io.mango.permission.api.po.SysMenu;
...
public class SysMenuController implements SysMenuApi {
    ...
    public R<SysMenu> getById(
        ...
        io.mango.permission.core.entity.SysMenu menu = sysMenuService.getById(menuId);
        if (menu == null) {
    ...
    public Set<String> getUserPermissions(Long userId) {
        return sysUserService.listUserPermissions(userId).stream().collect(Collectors.toSet());
    }

    @PostMapping
    @Operation(summary = "新增菜单")
    public R<Void> add(@RequestBody io.mango.permission.api.po.SysMenu menuPo) {
        io.mango.permission.core.entity.SysMenu menu = convertToEntity(menuPo);
    ...
    public R<Void> update(
            @Parameter(description = "菜单ID") @PathVariable Long menuId,
            @RequestBody io.mango.permission.api.po.SysMenu menuPo) {
        io.mango.permission.core.entity.SysMenu menu = convertToEntity(menuPo);
     ...
     */
    private SysMenu convertToApiPo(io.mango.permission.core.entity.SysMenu entity) {
        if (entity == null) {
            return null;
        }
     ...
     */
    private io.mango.permission.core.entity.SysMenu convertToEntity(io.mango.permission.api.po.SysMenu po) {
        if (po == null) {
            return null;
        }
        io.mango.permission.core.entity.SysMenu entity = new io.mango.permission.core.entity.SysMenu();
