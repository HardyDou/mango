...
public class SysUserController implements SysUserApi {
    ...
    public SysUser getByUsername(String username) {
        io.mango.permission.core.entity.SysUser user = sysUserService.getByUsername(username);
        if (user != null) {
    ...
    public SysUser getById(Long userId) {
        io.mango.permission.core.entity.SysUser user = sysUserService.getById(userId);
        if (user != null) {
            user.setPassword(null); // Remove password before returning
        }
        return convertToApiPo(user);
     ...
     */
    private SysUser convertToApiPo(io.mango.permission.core.entity.SysUser entity) {
        if (entity == null) {
            return null;
        }
