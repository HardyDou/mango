...
public class RedisAutoConfiguration {
    ...
    @Bean
    public RedissonClient redissonClient(RedisProperties mango, Environment env) {
    ...
    private String resolveHost(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolvePort(RedisProperties mango, @NonNull Environment env) {
    ...
    private String resolvePassword(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolveDatabase(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolveTimeout(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolvePoolMaxActive(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolvePoolMinIdle(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolvePoolMaxIdle(RedisProperties mango, @NonNull Environment env) {
    ...
    private int resolvePoolMaxWait(RedisProperties mango, @NonNull Environment env) {
