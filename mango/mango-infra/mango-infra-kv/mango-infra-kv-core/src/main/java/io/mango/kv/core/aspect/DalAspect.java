package io.mango.kv.core.aspect;

import io.mango.kv.api.*;
import io.mango.kv.api.annotation.Cacheable;
import io.mango.kv.api.annotation.Idempotent;
import io.mango.kv.api.annotation.Locker;
import io.mango.kv.api.annotation.RateLimit;
...
public class DalAspect {
    ...
    @Around("@annotation(io.mango.kv.api.annotation.Cacheable)")
    ...
    @Around("@annotation(io.mango.kv.api.annotation.RateLimit)")
    ...
    @Around("@annotation(io.mango.kv.api.annotation.Idempotent)")
    ...
    @Around("@annotation(io.mango.kv.api.annotation.Locker)")
