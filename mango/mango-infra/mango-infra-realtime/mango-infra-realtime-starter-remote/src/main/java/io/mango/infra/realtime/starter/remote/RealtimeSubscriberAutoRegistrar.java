...
public class RealtimeSubscriberAutoRegistrar {

    private final RealtimeSubscriberFeignClient subscriberApi;
    ...
    public void register() {
        ...
        RealtimeSubscriberRegistration registration = registration();
        subscriberApi.register(registration);
    ...
    public void unregister() {
        ...
        subscriberApi.unregister(registration());
    }
    ...
    private RealtimeSubscriberRegistration registration() {
        RealtimeRemoteProperties.Remote remote = properties.getInbound().getRemote();
        return new RealtimeSubscriberRegistration(
                serviceName(remote),
                contextPath(remote),
                remote.getEndpoint());
    }
