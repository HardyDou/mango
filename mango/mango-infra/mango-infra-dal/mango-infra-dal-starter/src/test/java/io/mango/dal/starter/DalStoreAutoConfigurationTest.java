...
class DalStoreAutoConfigurationTest {
    ...
    @Test
    void typeDb_withDataSourceAndRedissonBean_injectsDbKvStore() {
        new ApplicationContextRunner()
    ...
    void typeAuto_withDataSourceOnly_noRedis_injectsMemoryKvStore() {
        ...
        // because DbKvStore requires RedissonClient for ID generation
        new ApplicationContextRunner()
    ...
    void dalStoreProperties_defaultType_isAuto() {
        new ApplicationContextRunner()
                ...
                .run(context -> {
                    ...
                    DalStoreProperties props = context.getBean("mango.dal-io.mango.dal.starter.DalStoreProperties", DalStoreProperties.class);
