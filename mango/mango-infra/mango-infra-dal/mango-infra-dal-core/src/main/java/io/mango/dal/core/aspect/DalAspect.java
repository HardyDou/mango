...
public class DalAspect {
    ...
    @Around("@annotation(io.mango.dal.api.annotation.Cacheable)")
    ...
    @Around("@annotation(io.mango.dal.api.annotation.RateLimit)")
    ...
    @Around("@annotation(io.mango.dal.api.annotation.Idempotent)")
    ...
    @Around("@annotation(io.mango.dal.api.annotation.Locker)")
