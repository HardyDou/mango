...
class Sm3CryptoServiceTest {
    ...
    void hash_knownValue_returnsExpectedHash() {
        // Public standard vector mirrored by BouncyCastle SM3DigestTest.
        String hash = sm3Service.hash("abc");
        assertEquals("66c7f0f462eeedd9d1f2d46bdc10e4e24167c4875cf2f7a2297da02b8f4ba8e0", hash);
    }

    @Test
    void hash_secondStandardVector_returnsExpectedHash() {
        String hash = sm3Service.hash("abcd".repeat(16));

        assertEquals("debe9ff92275b8a138604889c18e5a4d6fdb70e5387e5765293dcba39c0c5732", hash);
    }
