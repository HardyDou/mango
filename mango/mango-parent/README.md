...
## 3. 适用场景
- 新增后端模块时继承统一构建基线。
- 升级 Spring Boot、Spring Cloud、MyBatis-Plus、Jackson、JWT、BouncyCastle 等全仓依赖版本。
- 统一 Maven compiler、surefire、checkstyle、spotbugs、pmd 等插件版本。
- 发布 release 或 snapshot 到公司 Maven 仓库。
