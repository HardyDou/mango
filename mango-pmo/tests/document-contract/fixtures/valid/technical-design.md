...
|---|---|---|---|---|---|---|---|---|---|
| IMP-001 | DEC-001, MOD-001, API-001, DB-001, UI-001 | 模块消费者和业务项目 | 没有公告审核能力 | 提供可追踪提交和审核 | 只新增能力且不改变既有契约 | 数据兼容升级失败时按 DB-001 补偿 | M08 已启用，更新模块 README 和能力地图 | 消费项目契约和端到端验证 | 能力负责人 |
