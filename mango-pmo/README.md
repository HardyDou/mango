...
```bash
npm view @mango/pmo@1.4.4 version --registry http://nexus.inner.yunxinbaokeji.com/repository/npm-group/
...
mango pmo upgrade --project-dir . --to 1.4.4 --dry-run
mango pmo upgrade --project-dir . --to 1.4.4 --sync-shell
