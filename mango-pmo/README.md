...
```bash
npm view @mango/pmo@1.3.6 version --registry http://nexus.inner.yunxinbaokeji.com/repository/npm-group/
npm view @mango/cli@1.0.91 version --registry http://nexus.inner.yunxinbaokeji.com/repository/npm-group/
npm install -g @mango/cli@1.0.91 --registry http://nexus.inner.yunxinbaokeji.com/repository/npm-group/
```
...
mango pmo upgrade --project-dir . --to 1.3.6 --dry-run
mango pmo upgrade --project-dir . --to 1.3.6 --sync-shell
...
mango pmo upgrade --project-dir . --to 1.3.6 --dry-run
mango pmo upgrade --project-dir . --to 1.3.6
mango pmo check --project-dir . --locked
```
