...
```bash
npm view @mango/pmo@1.4.0 version --registry http://nexus.inner.yunxinbaokeji.com/repository/npm-group/
...
mango pmo upgrade --project-dir . --to 1.4.0 --dry-run
mango pmo upgrade --project-dir . --to 1.4.0 --sync-shell
