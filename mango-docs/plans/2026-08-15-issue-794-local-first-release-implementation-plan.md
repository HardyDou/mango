...
| P8 首批试运行 | 最终五包执行新 `plan/prepare`，保留完整证据 | 精确清单、拓扑、封存 SHA、候选消费者 PASS | 本地 gates、registry doctor 只读检查 |
...
6. 生成一次性 `legacy-reconciliation` 记录，内容包含起点 Tag、首批最终 tree、五包版本、Common 恢复基线和 Issue #43/#791/#794。
