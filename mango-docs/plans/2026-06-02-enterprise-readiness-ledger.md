...
| ER-009 | GitHub Issue #31 | E2E API baseURL 去硬编码治理 | 已通过 PR #79 合并，E2E baseURL 由环境配置驱动 | 代码修复和 PR 合并 | Playwright 配置和测试引用检查；关键 E2E 可运行 | DONE | PR #79；`mango-docs/evidence/2026-06-03-issue-31-e2e-api-base-url/verification-report.md` |
| ER-010 | GitHub Issue #32 | `@mango/admin-shell` 产品级 API 与文档打磨 | 已通过 PR #83 合并，补齐产品级 README、dist 子入口导出和包边界测试 | `@mango/admin-shell` README、exports、构建配置、测试和证据 | API 文档和消费示例可用于业务项目；包测试、构建和 pack dry-run 通过 | DONE | PR #83；`mango-docs/evidence/2026-06-03-issue-32-admin-shell-api-docs/verification-report.md` |
