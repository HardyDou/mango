...
- 外部真实通道联调仍以交付台账中的 EXCEPTION 状态为准：不作为 PR #149 合并门禁，但仍是对应通道投产前必须关闭的风险。

## 6. 外部通道阻塞项

| 台账 ID | 状态 | 说明 |
|---|---|---|
| PAY-CHANNEL-003 | EXCEPTION | 通联等外部通道真实适配、验签、查单、退款、账单解析和联调证据未在本 PR 完整关闭，不作为 PR #149 合并门禁。 |
| PAY-CHANNEL-005 | EXCEPTION | 华夏银行等外部银行通道真实适配、网银支付、退款和回调联调证据未在本 PR 完整关闭，不作为 PR #149 合并门禁。 |
| PAY-CHANNEL-007 | EXCEPTION | 微信/支付宝等外部扫码真实路由和商户能力仍需机构确认并复测，不作为 PR #149 合并门禁。 |
| PAY-CHANNEL-008 | EXCEPTION | 连连及其它外部通道真实联调未纳入本 PR 完整关闭，不作为 PR #149 合并门禁。 |
