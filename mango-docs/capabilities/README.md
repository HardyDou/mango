...
| 栅格系统小组件 | `@mango/grid-widgets` | 通用能力，系统小组件与业务小组件注册聚合 | 可评估使用，需确认菜单运行时、跳转适配和小组件数据权限边界 | [README](../../mango-ui/packages/grid-widgets/README.md) | [README](../../mango-ui/packages/grid-widgets/README.md) |
