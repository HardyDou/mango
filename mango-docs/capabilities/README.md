...
| 2026-07-12 | PMO 可复现 bundle 发布候选：`@mango/pmo@1.1.0` 同时携带规范、合同、模板、Agent、项目 Skill 和 Codex plugin 投影；`@mango/cli@1.0.68` 提供项目锁、显式升级和本地回滚，并计划锁定 Maven backend `1.0.16` | [PMO package README](../../mango-ui/packages/mango-pmo/README.md)、[CLI README](../../mango-ui/packages/mango-cli/README.md) | [根 CHANGELOG](../../CHANGELOG.md)；npm 和 Maven 发布完成前均为候选 |
