...
/**
 * 获取公开的国际化语言包（所有语言）
 * @description 调用 /admin/i18n/public，返回格式 { "zh-cn": [...], "en": [...] }
 * 用于应用启动时初始加载
 */
export function getI18nPublic() {
  return get('/admin/i18n/public');
}
...
/**
 * 获取支持的语言列表
 * @description 调用 /admin/i18n/languages，返回 ["zh-cn", "en"]
 */
 ...
 * @param lang 语言代码
 * @description 调用 /admin/i18n/{lang}，由 i18n 模块直接返回
 */
