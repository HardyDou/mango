...
模板生成一个 Flyway migration 起点和一个菜单权限资源清单。业务项目需要按 [Resource 重置与增量发布场景手册](../mango-docs/guides/business-integration/resource-reset-incremental-release.md) 先划分 DDL、正式 Resource、Demo 和运行期数据，再选择发布模式。
