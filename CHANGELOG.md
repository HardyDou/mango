...
- Make generated business projects and generated-backend acceptance use the HTTPS Nexus endpoint so clean runners can resolve Mango dependencies without Maven's HTTP repository blocker.
