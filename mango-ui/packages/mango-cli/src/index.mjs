...
const defaultVersions = {
  ...
  mangoAdmin: readMangoPackageVersion('admin', '1.0.8'),
  mangoAdminPages: readMangoPackageVersion('admin-pages', '1.0.4'),
  mangoAdminShell: readMangoPackageVersion('admin-shell', '1.0.5'),
  mangoAppRuntime: readMangoPackageVersion('app-runtime', '1.0.2'),
  mangoAuth: readMangoPackageVersion('auth', '1.0.3'),
  mangoCalendar: readMangoPackageVersion('calendar', '1.0.5'),
  mangoCommon: readMangoPackageVersion('common', '1.0.3'),
  mangoFile: readMangoPackageVersion('file', '1.0.5'),
  mangoNotice: readMangoPackageVersion('notice', '1.0.5'),
  mangoNumgen: readMangoPackageVersion('numgen', '1.0.5'),
  mangoRbac: readMangoPackageVersion('rbac', '1.0.3'),
  mangoSystem: readMangoPackageVersion('system', '1.0.3'),
  mangoTemplate: readMangoPackageVersion('template', '1.0.5'),
  mangoWorkflow: readMangoPackageVersion('workflow', '1.0.5'),
  mangoWorkflowBusinessExample: readMangoPackageVersion('workflow-business-example', '1.0.5'),
  vue: '3.5.13',
  vueRouter: '^4.1.6',
  vueI18n: '9.2.2',
  pinia: '2.0.32',
