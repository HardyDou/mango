...
mango pmo upgrade --project-dir demo-custom --to 1.2.2
...
2. 首次迁移或升版先执行 `mango pmo upgrade --project-dir . --to 1.2.2 --dry-run` 查看计划。
