...
| `mango pmo upgrade`              | 原子升级到 CLI 精确依赖的 `@mango/pmo` bundle                    | `--project-dir`、`--to`、`--dry-run`、`--write-agents`、`--sync-shell`、`--adopt-governance` | PMO bundle、项目 Skill、GitHub/Gitea workflow、兼容资产和 `.mango` 备份目录                            |
