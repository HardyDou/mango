...
```bash
npm view @mango/pmo@1.3.5 version --registry "$MANGO_NPM_REGISTRY"
npm view @mango/cli@1.0.90 version --registry "$MANGO_NPM_REGISTRY"
npm install -g @mango/cli@1.0.90 --registry "$MANGO_NPM_REGISTRY"
```
