...
| `mango release registry doctor`  | 校验 npm/Maven publish/consume registry 地址、npm 发布身份、Maven settings server ID 和消费可达性 | npm/Maven 双角色 registry、Maven publish/consume server ID、`--json`                         | 不改文件                                                                                               |
