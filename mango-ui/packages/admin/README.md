...
- `@mango/admin@1.0.53` aggregates `@mango/admin-shell@1.0.48` and the optional `@mango/notice@1.0.29` peer for the message-center menu fix. Default entry, `full` sub-entry, style entries and page registration contracts remain compatible.
