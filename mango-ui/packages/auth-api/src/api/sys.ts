...
export function getAccountLoginTenantOptions(data: {
  ...
  return post('/auth/login-institutions', data, { ignoreToken: true }) as Promise<LoginTenantOption[]>;
}
...
export function getLoginTenantOptions() {
  return get('/system/tenant/login-options', { ignoreToken: true }) as Promise<LoginTenantOption[]>;
}
