...
export { default as NoticeAnnouncementView } from './views/announcement/index.vue';
export { default as NoticeAnnouncementUserView } from './views/announcement-user/index.vue';
