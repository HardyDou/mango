    ...
    <el-card>
      ...
      <el-form :inline="true" class="search-form">
        <el-form-item label="关键词">
          <el-input v-model="query.keyword" placeholder="搜索权限名称/编码" clearable />
        </el-form-item>
        <el-form-item label="类型">
          <el-select v-model="query.permissionType" placeholder="请选择" clearable>
      ...
      <el-table v-loading="loading" :data="tableData" stripe>
        ...
        <el-table-column prop="resource" label="资源路径" show-overflow-tooltip />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑权限' : '新增权限'" width="500px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="资源路径" prop="resource">
          <el-input v-model="form.resource" placeholder="请输入资源路径，如: /api/system/user" />
        </el-form-item>
...
const mockPermissions: SysPermission[] = [
  ...
  },
  {
    ...
    permissionType: 2,
    resource: '/api/system/role',
    description: '新增角色',
    status: 1,
    createTime: '2024-01-02 10:01:00',
  },
  {
    id: 7,
    permissionName: '角色编辑',
    ...
    description: '编辑角色',
    status: 1,
    createTime: '2024-01-02 10:02:00',
  },
  {
    id: 8,
    permissionName: '菜单查看',
  ...
  {
    id: 11,
    permissionName: 'API权限',
    permissionCode: 'system:api:access',
    permissionType: 3,
    resource: '/api/**',
    description: 'API访问权限',
    status: 1,
